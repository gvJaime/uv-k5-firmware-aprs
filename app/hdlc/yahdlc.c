...
int16_t yahdlc_set_state(yahdlc_state_t *state) {
  if (!state) {
    return -EINVAL;
  }
...
int16_t yahdlc_get_state(yahdlc_state_t *state) {
  if (!state) {
    return -EINVAL;
  }
...
void yahdlc_escape_value(uint8_t value, uint8_t *dest, int16_t *dest_index) {
...
int16_t yahdlc_get_data(yahdlc_control_t *control, const uint8_t *src,
                    uint16_t src_len, uint8_t *dest, uint16_t *dest_len) {
  return yahdlc_get_data_with_state(&yahdlc_state, control, src, src_len, dest, dest_len);
}

int16_t yahdlc_get_data_with_state(yahdlc_state_t *state, yahdlc_control_t *control, const uint8_t *src,
                    uint16_t src_len, uint8_t *dest, uint16_t *dest_len) {
  int16_t ret;
  uint8_t value;
  uint16_t i;
...
int16_t yahdlc_frame_data(yahdlc_control_t *control, const uint8_t *src,
                      uint16_t src_len, uint8_t *dest, uint16_t *dest_len) {
  uint16_t i;
