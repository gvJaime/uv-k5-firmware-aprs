 ...
 */
int16_t yahdlc_get_data(yahdlc_control_t *control, const int8_t *src,
 ...
 * @see yahdlc_get_data
 */
int16_t yahdlc_get_data_with_state(yahdlc_state_t *state, yahdlc_control_t *control, const int8_t *src,
                               uint16_t src_len, uint8_t *dest, uint16_t *dest_len);
 ...
 * @retval -EINVAL Invalid parameter
 */
int16_t yahdlc_frame_data(yahdlc_control_t *control, const int8_t *src,
                      uint16_t src_len, int8_t *dest, uint16_t *dest_len);
